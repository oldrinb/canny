      ...
      .then(function(values) {
        ...
        texSampler1Array_ =
            [programs_[this.MAIN].getUniformLocation("leftTexSampler"),
             ...
             programs_[this.NON_MAXIMUM].getUniformLocation("texSampler1"),
        ...
        texSampler2Array_ =
            [programs_[this.MAIN].getUniformLocation("rightTexSampler"),
             ...
             programs_[this.NON_MAXIMUM].getUniformLocation("texSampler2"),
        ...
        texSampler3Array_ =
            [programs_[this.MAIN].getUniformLocation("edgeTexSampler"),
             null, null,
             programs_[this.NON_MAXIMUM].getUniformLocation("angleTexSampler"),
